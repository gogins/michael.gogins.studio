...
\begin{itemize}
\item I will discuss my piece \emph{\textbf{Red Leaves v8.4.3.4.stereo}}, which I performed here last Wednesday evening.
...
\item I committed every variant to my GitHub repository so I could restore it if needed.
\item This piece has a number of dependencies so I will just play it and talk about it. 
\item You should load it in your editor and follow along as I speak. 
