...
\item This causes an abrupt discontinuity in the waveform, which is the same as noise in the frequency domain. This is visible in the spectrogram as extra energy in the vertical dimension.
...
\item Always use a releasing envelope, or a de-clicking envelope (more on this later).
\end{itemize}
\end{frame}
