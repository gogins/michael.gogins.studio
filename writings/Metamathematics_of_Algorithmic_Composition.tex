...
\begin{description}
\item[$\mathsf{ST}$]  Julia sets with Siegel discs or Cremer points may be of musical interest in the abstract, but they are uncomputable. Picking Julia set parameters at random will not find one of these.
