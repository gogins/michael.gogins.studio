...
It is now possible to return to the question of algorithmic composition with more understanding. I will use parametric composition as standing in for algorithmic composition in general. It turns out that parametric composition spans the entire hierarchy of complexity classes.
...
\item[Intrinsic vs.\ Extrinsic] Algorithms that work with musical primitives and transformations do not produce nearly as many musically unacceptable results.
...
However, it would not be wise to exclude extrinsic algorithms from the toolkit, as they can be a fertile source of materials that expand notions of what is musically acceptable.
