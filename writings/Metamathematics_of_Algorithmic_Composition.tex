...
But if $\mathsf{P} \ne \mathsf{NP}$, parametric maps must exclude not only sets with Siegel discs or Cremer points, but also larger neighborhoods of these points. This would to some extent fracture and obstruct the intelligibility of algorithmic composition.
