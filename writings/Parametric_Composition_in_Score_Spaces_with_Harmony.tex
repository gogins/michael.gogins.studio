...
in the score, assuming that the Hutchinson operator is sufficiently contractive.
Additional chords may also be generated depending on the scaling factors $s$,
the number of interpolation points, and so on.
