...
\cite{csoundextended} for algorithmic composition in C++; and finishes with 
...
\begin{figure}
\centerline{\includegraphics[width = 0.75\textwidth]{OPTC}}
...
\begin{figure}
\centerline{\includegraphics[width = 0.75\textwidth]{OPTIC}}
