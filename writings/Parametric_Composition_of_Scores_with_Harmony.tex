...
numbers, $v$ loudness as real-valued MIDI velocity numbers, and instrument as
real-valued MIDI channel numbers.
...
interpolation points \eqref{interpolationPoints} as follows. The transformation
matrices are constrained such that $W_i I_0 = I_{i-1}$ and $W_i I_N = I_i$.
