...
int main(int argc, const char **argv)
{
    ...
    model.setTitle("Blue Leaves 4e Ambisonic 1");
    model.setFilename("Blue_Leaves_4e Ambisonic 1");
...
gk_BformatDecoder_SpeakerRig    init                    1
gk_Spatialize_SpeakerRigRadius  init                    20.0
...
k_space_from_to_back, k_space_left_to_right, k_space_bottom_to_top random_point_from_sphere gi_radius
