...
int main(int argc, const char **argv)
{
    ...
    model.setTitle("Blue Leaves 4e2 Ambisonic 2b");
    model.setFilename("Blue_Leaves_4e2 Ambisonic 2b");
...
p3                              =                       isustain + iattack + irelease
adeclick                        linsegr                  0.0, iattack, 1.0, isustain, 1.0, irelease, 0.0
iamplitude                      =                       ampdb(i_midikey) / 2400 ;; levels 1200
ip6                             =                       0.3
ip7                             =                       2.2
                                ; shift it.
ishift                          =                       4.0 / 12000
...
i_homogeneity                   =                       p11
ifrequency                      =                       cpsmidinn(i_midikey)
iamplitude                      =                       ampdb(i_midivelocity) / 175 * 1.5 ;;levels
                                ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
k_space_front_to_back           init                    gi_PanningExpansion * -5
k_space_left_to_right           init                    gi_PanningExpansion * 2
k_space_bottom_to_top           init                    gi_PanningExpansion * 0
...
k_space_front_to_back           init                    gi_PanningExpansion * -5
k_space_left_to_right           init                    gi_PanningExpansion * -6
k_space_bottom_to_top           init                    gi_PanningExpansion * 2
...
k_space_front_to_back           init                    gi_PanningExpansion * -5
k_space_left_to_right           init                    gi_PanningExpansion * -.5
k_space_bottom_to_top           init                    gi_PanningExpansion * 0
...
k_space_front_to_back           init                    gi_PanningExpansion * -5
k_space_left_to_right           init                    gi_PanningExpansion * 6.5
k_space_bottom_to_top           init                    gi_PanningExpansion * 0
...
asignal                         =                       asignal * iamplitude
;aoutleft, aoutright		        pan2			        asignal * adeclick, i_pan
a_signal                        =                       asignal * adeclick *.5 ;;levels

;k_space_front_to_back           init                    gi_PanningExpansion * -5
;k_space_left_to_right           init                    gi_PanningExpansion * -2
;k_space_bottom_to_top           init                    gi_PanningExpansion * 2
k_space_left_to_right           line                    gi_PanningExpansion * 0, p3, gi_PanningExpansion * -2
k_space_bottom_to_top           line                    gi_PanningExpansion * 0, p3, gi_PanningExpansion * 3
k_space_front_to_back           line                    gi_PanningExpansion * -5, p3, gi_PanningExpansion * -1
...
k_space_front_to_back           init                    gi_PanningExpansion * -5
k_space_left_to_right           init                    gi_PanningExpansion * 8
k_space_bottom_to_top           init                    gi_PanningExpansion * -1
...
;k_space_front_to_back           init                    gi_PanningExpansion * -5
;k_space_left_to_right           init                    gi_PanningExpansion * 0
;k_space_bottom_to_top           init                    gi_PanningExpansion * 3
k_space_left_to_right           line                    gi_PanningExpansion * 0, p3, gi_PanningExpansion * 0
k_space_bottom_to_top           line                    gi_PanningExpansion * 0, p3, gi_PanningExpansion * 3
k_space_front_to_back           line                    gi_PanningExpansion * -5, p3, gi_PanningExpansion * -1
...
k_space_left_to_right           line                    gi_PanningExpansion * 0, p3, gi_PanningExpansion * .5
k_space_bottom_to_top           line                    gi_PanningExpansion * 0, p3, gi_PanningExpansion * 0
k_space_front_to_back           line                    gi_PanningExpansion * -5, p3, gi_PanningExpansion * -1
