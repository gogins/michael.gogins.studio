...
if len(sys.argv) >= 2:
    ...
    print
    rendering = "audio"
print(f'Rendering as: {rendering}')
...
rendering_commands = {
    'soundfile':    'csound -d -r 48000 -k 128 -m162 -+msg_color=0 -RWZdfo %s' % (soundfile_name),
    'audio':        'csound -d -r 48000 -k 128 -m162 -+msg_color=0 -o%s'       % (dac_name),
}
...
;;vst3note gi_Pianoteq, 0, i_midi_key, i_midi_velocity, i_duration
...
a_out_left, a_out_right pan2 a_signal, k_space_left_to_right
outleta "outleft", a_out_left * 6
outleta "outright", a_out_right * 6
prints "%-24s i %9.4f t %9.4f d %9.4f k %9.4f v %9.4f p %9.4f #%3d\\n", nstrstr(p1), p1, p2, p3, p4, p5, p7, active(p1)
...
#else
a_out_left, a_out_right pan2 a_signal, k_space_left_to_right
outleta "outleft", a_out_left * 4
outleta "outright", a_out_right * 4
#endif
...
#else
a_out_left, a_out_right pan2 a_signal, k_space_left_to_right
outleta "outleft", a_out_left * 3
outleta "outright", a_out_right * 3
#endif
prints "%-24s i %9.4f t %9.4f d %9.4f k %9.4f v %9.4f p %9.4f #%3d\\n", nstrstr(p1), p1, p2, p3, p4, p5, p7, active(p1)
...
gk_PianoOutPianoteq_level init 24
...
outleta "outleft", a_out_left * 30
outleta "outright", a_out_right * 30
prints "%-24s i %9.4f t %9.4f d %9.4f k %9.4f v %9.4f p %9.4f #%3d\\n", nstrstr(p1), p1, p2, p3, p4, p5, p7, active(p1)
endin
...
for i, event in reverse_enumeration(score):
    ...
    if len(sounding) == total_instruments:
        break
score.setDuration(score_duration / 1.5)
score.save(title + ".mid")
model.performMaster()
