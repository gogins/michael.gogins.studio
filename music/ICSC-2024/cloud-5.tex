...
The cloud-5 user interface consists of main menu runs across the top of the page. Clicking on a button can start or stop performance, or show an overlay that fills the rest of the page. 
