...
pan = -.875
model.arrange( 0,        8,      -30.0,          pan )
pan = pan + panIncrement
model.arrange( 1,       20,      -30.0,          pan )
pan = pan + panIncrement
model.arrange( 2,       34,      -36.0,          pan )
pan = pan + panIncrement
model.arrange( 3,       14,      -33.0,          pan )
pan = pan + panIncrement
model.arrange( 4,        7,      -30.0,          pan )
pan = pan + panIncrement
model.arrange( 5,        9,      -30.0,          pan )
