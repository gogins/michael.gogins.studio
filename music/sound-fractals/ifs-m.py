...
class IfsToSoundfile(object):
	def __init__(self, iterations = 10, durationSeconds = 300.0, minimumHz = 27.5*2.0, maximumHz = 14000.0, width=12000, height=400):
...
if __name__ == '__main__':
	ifs = IfsToSoundfile()
	#                   a        b        c        d        e        f        w
##	ifs.addTransform(   0.5000,  0.0000,  0.0000,  0.5000, -2.563477, -0.000003,  1.000 )
##	ifs.addTransform(   0.5000,  0.0000,  0.0000,  0.5000,  2.436544, -0.000003,  2.000 )
	ifs.addTransform(   0.0000, -0.5000,  0.5000,  0.0000,  4.873085,  7.563492,  1.000 )

	ifs.addTransform(   0.2400,  0.0000,  0.0000,  0.2500,  0.000000,  0.000000,  5.000 )
	ifs.addTransform(   0.0250,  0.0000,  0.0000,  0.2000,  0.000000,  1.000000,  1.000 )
	ifs.addTransform(   0.2500,  0.0000,  0.0000,  0.2400,  0.060000,  2.000000,  6.000 )
	ifs.addTransform(   0.2500,  0.0000,  0.0000,  0.2500,  0.000000,  3.000000,  1.000 )

	ifs.addTransform(   0.2500,  0.0000,  0.0000,  0.0250,  1.000000,  0.000000,  6.000 )
	ifs.addTransform(   0.02500,-0.8000,  0.8000,  0.2500,  1.050000,  0.800000,  5.000 )
	ifs.addTransform(   0.2500,  0.0000,  0.0000,  0.2500,  1.000000,  2.200000,  1.000 )
	ifs.addTransform(   0.2500,  0.0000,  0.0000,  0.2500,  1.000000,  3.000000,  1.000 )

	ifs.addTransform(   0.2500,  0.0000,  0.0000,  0.2500,  1.980000,  0.000000,  7.000 )
	ifs.addTransform(   0.2500,  0.0200,  0.0000,  0.0250,  2.000000,  1.100000,  2.000 )
	ifs.addTransform(   0.0300,  0.0000,  0.0000,  0.2500,  2.000000,  2.000000,  1.000 )
	ifs.addTransform(   0.2500,  0.0000,  0.0000,  0.2500,  2.000000,  3.000000,  1.000 )

	ifs.addTransform(   0.2500,  0.0000,  0.0000,  0.2500,  3.000000,  0.000000,  5.000 )
	ifs.addTransform(   0.2500,  0.0000,  0.4000,  0.2500,  3.000000,  1.000000,  1.000 )
	ifs.addTransform(   0.2500,  0.0000,  0.0000,  0.3300,  3.000000,  2.100000,  3.000 )
	ifs.addTransform(   0.2500,  0.0000,  0.0000,  0.3500,  3.000000,  3.000000,  1.000 )
