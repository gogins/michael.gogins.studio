...
if __name__ == '__main__':
	ifs = IfsToSoundfile()
	#                   a       b       c       d           e       f       w
	ifs.addTransform(   0.45,   0.0,    0.0,    0.41000,    0.0,    0.0,    0.5 )
	ifs.addTransform(   0.5,   -0.1,    0.1,    0.51100,    2.1,    0.1,    0.2 )
	ifs.addTransform(  -0.48,   0.2,   -0.2,    0.41110,    0.013,    1.0,    1.0 )
	ifs.addTransform(   0.5,    0.0,    0.0,    0.41011,    2.9,    1.0,    0.7 )
	ifs.iterate()
