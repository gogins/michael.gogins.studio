...
class IfsToSoundfile(object):
	def __init__(self, iterations = 10, durationSeconds = 120.0, minimumHz = 27.5, maximumHz = 14000.0, width=4000, height=400):
...
if __name__ == '__main__':
	ifs = IfsToSoundfile()
	#                   a        b        c        d        e        f        w
	ifs.addTransform(   0.2550,  0.0000,  0.0000,  0.2550,  0.3726,  0.6714,  1.000 )
	ifs.addTransform(   0.2550,  0.0000,  0.0000,  0.2550,  0.1146,  0.2232,  2.000 )
	ifs.addTransform(   0.2550,  0.0000,  0.0000,  0.2550,  0.6306,  0.2232,  1.000 )
	ifs.addTransform(   0.3700, -0.6420,  0.6420,  0.3700,  0.6456,  0.0000,  3.000 )
	ifs.iterate()
