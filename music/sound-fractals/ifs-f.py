...
if __name__ == '__main__':
	ifs = IfsToSoundfile()
	#                   a         b     c     d         e         f         w
	ifs.addTransform(   0.0,      0.0,  0.0,  1.0/3.0,  1.0/3.0,  2.0/3.0,  1.0 )
	ifs.addTransform(   1.0/3.0,  1.0,  1.0,  0.0,      2.0/3.0,  0.0,      1.0 )
	ifs.addTransform(  -1.0/3.0,  1.0,  1.0,  0.0,      1.0/3.0,  0.0,      1.0 )
	ifs.iterate()
