...
This script demontrates how to use Python to integrate Abjad for algorithmic
scoring with Csound for audio rendering.

This script is also designed to test the quality of musical expression in
the rendering, as compared with the score.
'''
print __doc__
import abjad
import csnd6
...
'''
csound = csnd6.Csound()
print 'version:', csound.GetVersion()
