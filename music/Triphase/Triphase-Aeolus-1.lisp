...
;(seq-to-lilypond csound-seq "Triphase-Aeolus-1.ly" *organ-part* partids voices)

;(defparameter output "Triphase-Aeolus-1.wav")
...
(unless (equal output "dac")    
    ...
    (uiop:run-program '("python" "../post-process.py" "Triphase-Aeolus-1.wav") :output t)
    (uiop:run-program '("aplay" "Michael Gogins -- Triphase Aeolus 1.master.wav") :output t)
)
(quit)
