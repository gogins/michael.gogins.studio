...
class IfsToSoundfile(object):
	def __init__(self, iterations = 10, durationSeconds = 240.0, minimumHz = 27.5*2.0, maximumHz = 14000.0, width=8000, height=800):
...
if __name__ == '__main__':
	ifs = IfsToSoundfile()
	#                   a        b        c        d        e        f        w
##	ifs.addTransform(   0.5000,  0.0000,  0.0000,  0.5000, -2.563477, -0.000003,  1.00001 )
...
##	ifs.addTransform(   0.0000, -0.5000,  0.5000,  0.0000,  4.873085,  7.563492,  1.000 )
	ifs.addTransform(   0.5500,  0.0000,  0.0000,  0.5000, -2.563477, -0.000003,  1.000 )
	ifs.addTransform(   0.5000,  0.0000,  0.0000,  0.4000,  2.536544, -0.000003,  2.000 )
	ifs.addTransform(   0.0000, -0.5000,  0.5000,  0.0000,  4.873085,  6.563492,  0.99999 )
	ifs.addTransform(   0.0000, -0.6700,  0.6100,  0.0000,  4.873085,  7.563492,  1.000 )
	ifs.iterate()
