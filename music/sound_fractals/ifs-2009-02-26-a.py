...
class IfsToSoundfile(object):
    ...
    def render(self, m):
        ...
        for x in xrange(self.width):
            ...
            for y in xrange(self.height):
                # The image is upside down, and must be inverted.
                f = self.height - y - 1
                if self.heightIsFrequency:
                ...
                self.soundfile.cosineGrain(t, self.grainSeconds, Hz, float(m[x, f]) * 0.001, 0.0, 0.0, True, True)
...
if __name__ == '__main__':
    ...
    transformations = parseFlame(r'D:\utah\home\mkg\projects\music\01_workshop\ifs\Apophysis-090225-437.flame', 'Apophysis-090226-11', ifs)
    ifs.iterate()
