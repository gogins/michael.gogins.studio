...
<script type='text/javascript' src='silencio/js/canvas_wrapper.js'></script>
...
if kwaveform == 0 goto kwaveform_0
goto kwaveform_endif
kwaveform_0:
asignal poscil3 1, ihertz, isine
goto kwaveform_endif
if kwaveform == 1 goto kwaveform_1
goto kwaveform_endif
kwaveform_1:
asignal vco2 1, ihertz, 8 ; integrated saw
goto kwaveform_endif
if kwaveform == 2 goto kwaveform_2
goto kwaveform_endif
kwaveform_2:
