...
vst3 opcodes, the signal flow graph opcodes, and the WebKit opcodes, all in 
one .csd file.
...
the vst3 opcodes for Csound, and the Pianoteq VST plugin from Modartt.
...
/*
cxx_invokable.hpp - this file is part of cxx-opcodes.
...
class ClangInvokableBase : public ClangInvokable {
    public:
         ...
         * be compatible with Csound's inputs to `cxx_invoke`.
         */
...
i_result cxx_compile "grain_main", S_grain_code, "-g -Ofast -march=native -std=c++14 -I/home/mkg/cxx-opcodes -I/usr/local/include/csound  -I. -stdlib=libstdc++", "/usr/lib/gcc/x86_64-linux-gnu/9/libstdc++.so /usr/lib/gcc/x86_64-linux-gnu/9/libgcc_s.so /usr/local/lib/libstk.so /usr/lib/x86_64-linux-gnu/libm.so /usr/lib/x86_64-linux-gnu/libpthread.so"
