...
vst opcodes, the signal flow graph opcodes, and the WebKit opcodes, all in 
one .csd file.
...
the vst opcodes for Csound, and the Pianoteq VST plugin from Modartt.
...
The piece uses the vst opcodes, partly written and now maintained by 
me, for hosting the Pianoteq physically modelled piano as a VST2 plugin, and 
for using the freeware M plugin, which provides a good implementation 
...
Currently, I contribute code to Csound, maintain the vst opcodes for 
...
<CsOptions>
-dm195 ; --opcode-lib="../../build-macos/lib/Debug/libvst_plugins.dylib" -z1
</CsOptions>
<CsInstruments>
...
vstinfo gi_Pianoteq
gi_Mverb2020 vstinit "/home/mkg/.local/lib/Mverb2020.so", 0
vstinfo gi_Mverb2020
;;; gi_Pianoteq vstinit "/Library/Audio/Plug-Ins/VST3/Pianoteq 7.vst", "Pianoteq 7", 0 ; 1
;;;vstinfo gi_Pianoteq
...
// automatically define it. Therefore, we define it here if necessary.
...
gi_webserver webserver_create "/home/mkg/Dropbox/apnm-renderings/", 8080, 0
