...
class Composition(object):
    def generate(self):
        ...
        rescale.setRescale( CsoundAC.Event.DURATION,   0, 0,  0.25,    1.0  )
        rescale.setRescale( CsoundAC.Event.INSTRUMENT, 1, 0,  1,       0    )
        rescale.setRescale( CsoundAC.Event.KEY,        1, 0, 60,       36   )
        rescale.setRescale( CsoundAC.Event.VELOCITY,   1, 1, 15,       12   )
        rescale.setRescale( CsoundAC.Event.PAN,        1, 1, -0.875,   1.75 )
