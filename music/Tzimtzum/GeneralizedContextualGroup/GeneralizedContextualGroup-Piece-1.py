...
x   /home/mkg/Dropbox/studio/01_workshop/mkg-2008-12-24-a.py:27
x   /home/mkg/Dropbox/studio/01_workshop/mkg-2008-12-25-a.py:27
x   /home/mkg/Dropbox/studio/01_workshop/mkg-2008-12-25-b.py:27
x   /home/mkg/Dropbox/studio/01_workshop/mkg-2009-01-01-a.py:27
x   /home/mkg/Dropbox/studio/01_workshop/mkg-2009-01-10-a.py:27
x   /home/mkg/Dropbox/studio/01_workshop/mkg-2009-01-10-b.py:27
...
class Composition(object):
    ...
    def generate18(self):
        ...
        gcg.addRule('B', 'B Q2 WV V+2 W Q2 WV V+1 W V+3 V+ WV V-3 Q7 WV D- WV Q5 D+ D+ WV K D- D- B D+')
    ...
    def generate16(self):
        ...
        gcg = GeneralizedContextualGroup.GeneralizedContextualGroup()
        gcg.thisown = 0
        gcg.setAxiom('S(0,4,7,10,14) R36 WV A')
        gcg.addRule('A', 'V+8 K WV Q7 K D-2 WC V+9 WC V-7 WC V+11 A D+2 L- A L+ Q2 WV A')
    ...
    def generate15(self):
        ...
        rescale.setRescale( CsoundAC.Event.KEY,        True,  False, 60-24+3, 36   )
        rescale.setRescale( CsoundAC.Event.VELOCITY,   True,  True,  15,       12   )
        rescale.setRescale( CsoundAC.Event.PAN,        True,  True,  -0.875,   1.75 )
        # random.addChild(lindenmayer)
        rescale.addChild(gcg)
    ...
    ### gcg.setAxiom('R48 D/4 pcs1 ar1 a1 c dD+ pcs2 ar2 a2 c dD- pcs3 ar3 a3 c pcs4 ar4 a4 c a4 pcs3 c dD- ar3 a3 c pcs2 ar2 a2 c pcs1 dD+ ar1 a1 c c')
        ...
        gcg.addRule('ck2',  'K     WV      WV      WV dD+  WV V+3  WC      WC      WC      WC ')
    ...
    def generate4(self):
        ...
        rescale.setRescale( CsoundAC.Event.INSTRUMENT, True,  True,   1,       3.99 )
        ### rescale.setRescale( CsoundAC.Event.KEY,        True,  False, 39,       36   )
        rescale.setRescale( CsoundAC.Event.KEY,        True,  True,  39,       36   )
        rescale.setRescale( CsoundAC.Event.VELOCITY,   True,  True,  46,       14   )
        rescale.setRescale( CsoundAC.Event.PAN,        True,  True,  -0.95,  1.90   )
        # random.addChild(lindenmayer)
        self.sequence.addChild(rescale)
...
aeolus_note gi_aeolus, insnum, p4, p5
...
endin
    ...
    def render(self):
        ...
        self.model.setCsoundScoreHeader("f 0 340\n")
    ...
    def __init__(self, author='Composer', rendering='audio', instrumentLibrary=r'/home/mkg/csound-extended/test-examples/csound-vst/CsoundAC.csd', soundfilePlayer=r'/usr/bin/audacity'):
