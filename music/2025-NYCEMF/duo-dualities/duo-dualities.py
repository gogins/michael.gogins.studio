...
gcg.addRule( 'section2', 'B12 R45 P(0,3,5,10) V+36 L/12 D*2.25 I0=5 I1=2 I2=5 I3=5 I4=2 I5=5 T+2 V+27 a3x a5 D/2.225 V-7 L*12 ')
gcg.addRule( 'section3', 'B0  R70 P(0,4,7) V+109 O.15 I0=3 I1=2 I2=1 L*12 arp1 dd K D*1.875 L/4 a4x a6 V-4 B0 K  arp2 arp2 B3 dd dd T+6 sV-2 D*2 WV WC WC WC WC WC ') 
