...
gcg.addRule( 'section3', 'B12   R70 P(0,4,7) V+109 O.15 I0=3 I1=2 I2=1 L*12 arp1 dd K D*1.875 L/4 a4x a6 K V-24 B0 arp2 arp2 B3 dd dd T+6 sV-2 D*2 WV WC WC WC WC WC ') 
...
rescale.setRescale( CsoundAC.Event.KEY,        True, False, 24,             48     )
