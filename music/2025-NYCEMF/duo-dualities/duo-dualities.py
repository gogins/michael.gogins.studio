...
gcg.setAxiom('section1 dd dd dd T+2 V-13 O.2 section2 T+5 V-2 section3 D/2.5 ') 
gcg.addRule( 'section1', 'B3  R63 P(0,4,7) V+9 I0=1 I1=2 I2=3 V+11 a3 dd a4 dd ') 
gcg.addRule( 'section2', 'B12 R41 P(0,4,7,11,14) V+3 6 L*2 D*2.25 I0=5 I1=2 I2=5 I3=5 I4=2 I5=5 T+2 V+37 a3 D/2.225 ') 
gcg.addRule( 'section3', 'B0  R70 P(0,4,7) V+109 O.15 I0=3 I1=2 I2=1 L/2 arp1 dd K D*1.875 L/4 a4 V-4 B7 arp2 arp2 B3 dd dd T+6 sV-2 D*2 WV WC WC WC WC WC ') 
