...
extern "C" int score_generator(CSOUND *csound) {
    ...
    generators.push_back([&chordsForTimes, &modality, &base_level](const Cursor &pen_, int depth, csound::Score &score) {
        ...
        pen.note[csound::Event::KEY] =  (pen.note[csound::Event::KEY]                 * 1./3.)    + (1.)      * 100.;
        return pen;
    });
    generators.push_back([&chordsForTimes, &modality, &base_level](const Cursor &pen_, int depth, csound::Score &score) {
        Cursor pen = pen_;
        pen.note[csound::Event::TIME] = (pen.note[csound::Event::TIME]                * 1./4.)    + (1./4.)   * 100.;
        pen.note[csound::Event::KEY] =  (pen.note[csound::Event::KEY]                 * 1./1.5)   + (1.)      *  95.;
        return pen;
    });
    generators.push_back([&chordsForTimes, &modality, &base_level](const Cursor &pen_, int depth, csound::Score &score) {
        Cursor pen = pen_;
    ...
    generators.push_back([&chordsForTimes, &modality, &base_level](const Cursor &pen_, int depth, csound::Score &score) {
        ...
        pen.note[csound::Event::KEY] =          (pen.note[csound::Event::KEY]         * 1./2.1)   + ( 1.)    * 100.;
    ...
    generators.push_back([&chordsForTimes, &modality, &base_level](const Cursor &pen_, int depth, csound::Score &score) {
        ...
        pen.note[csound::Event::TIME] =         (pen.note[csound::Event::TIME]        * 1./3.2)   + (0.)    * 100.;
        pen.note[csound::Event::KEY] =          (pen.note[csound::Event::KEY]         * 1./2.)    + (0.)    * 110.;
        return pen;
    });
    generators.push_back([&chordsForTimes, &modality, &base_level](const Cursor &pen_, int depth, csound::Score &score) {
        Cursor pen = pen_;
        ...
        pen.note[csound::Event::TIME] =         (pen.note[csound::Event::TIME]        * 1./3.)    + (1./3.) * 125.;
        pen.note[csound::Event::KEY] =          (pen.note[csound::Event::KEY]         * 1./4.)    + (0.)    *  50.;
    ...
    generators.push_back([&chordsForTimes, &modality, &base_level](const Cursor &pen_, int depth, csound::Score &score) {
        ...
        pen.note[csound::Event::KEY] =  (pen.note[csound::Event::KEY]                 * 1./2.)    + (0.)    * 155;
        pen.note[csound::Event::INSTRUMENT] =  (pen.note[csound::Event::INSTRUMENT]   * 0.75)     + (-3.);
        return pen;
        return pen;
    });
