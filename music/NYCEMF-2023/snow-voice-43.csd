...
Csound score. The score is generated using my CsoundAC library for algorithmic 
composition. The basic structure of the piece is a recurrent iterated function 
system of notes, but the system also generates root progressions and 
modulations for the notes.
