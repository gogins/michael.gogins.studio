...
is what musicians normally mean by ``chord type.''
    ...
    \begin{figure}
        \centerline{\includegraphics[width = 0.5\textwidth]{optc}}
...
abstract commonly used concept of what is a ``chord.''
    ...
    \begin{figure}
        \centerline{\includegraphics[height = 0.5\textwidth]{optic}}
...
\footnotetext{Image in \ref{fig:kochflake} licensed Creative Commons 
...
\footnotetext{Image in \ref{fig:rboperator} from \cite{barnsley2015bilinear}.} 
